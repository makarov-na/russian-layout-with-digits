...
### Feature: Layout variant registration
...
### Feature: Classic top row digits
The top digit row (AE01–AE10) SHALL use classic programmer-friendly shifted symbols.
...
### Feature: Function key shortcuts
Shift+FK keys SHALL output common programmer symbols.
